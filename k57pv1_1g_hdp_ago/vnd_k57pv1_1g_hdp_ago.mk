...
MTK_BASE_PROJECT := k57pv1_1g_hdp_ago
...
PRODUCT_NAME := vnd_k57pv1_1g_hdp_ago
PRODUCT_DEVICE := $(strip $(MTK_BASE_PROJECT))
PRODUCT_MODEL := k57pv1_1g_hdp_ago
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= k57pv1_1g_hdp_ago_debug_defconfig
else
KERNEL_DEFCONFIG ?= k57pv1_1g_hdp_ago_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= k57pv1_1g_hdp_ago
LK_PROJECT ?= k57pv1_1g_hdp_ago
TRUSTY_PROJECT ?= k57pv1_1g_hdp_ago
