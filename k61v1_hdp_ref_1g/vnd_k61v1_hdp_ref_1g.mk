MTK_TARGET_PROJECT := k61v1_hdp_ref_1g
MTK_BASE_PROJECT := k61v1_hdp_ref_1g
...
PRODUCT_NAME := vnd_k61v1_hdp_ref_1g
PRODUCT_DEVICE := $(strip $(MTK_BASE_PROJECT))
PRODUCT_MODEL := k61v1_hdp_ref_1g
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= k61v1_hdp_ref_1g_debug_defconfig
else
KERNEL_DEFCONFIG ?= k61v1_hdp_ref_1g_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= k61v1_hdp_ref_1g
LK_PROJECT ?= k61v1_hdp_ref_1g
TRUSTY_PROJECT ?= k61v1_hdp_ref_1g
