...
PRODUCT_NAME := vnd_k50v1_bsp
PRODUCT_DEVICE := $(strip $(MTK_BASE_PROJECT))
PRODUCT_MODEL := k50v1_bsp
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= k50v1_bsp_debug_defconfig
else
KERNEL_DEFCONFIG ?= k50v1_bsp_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= k50v1_bsp
LK_PROJECT ?= k50v1_bsp
TRUSTY_PROJECT ?= k50v1_bsp
