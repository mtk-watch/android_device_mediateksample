MTK_TARGET_PROJECT := k61v1_hdp_ref
MTK_BASE_PROJECT := k61v1_hdp_ref
...
PRODUCT_NAME := vnd_k61v1_hdp_ref
PRODUCT_DEVICE := $(strip $(MTK_BASE_PROJECT))
PRODUCT_MODEL := k61v1_hdp_ref
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= k61v1_hdp_ref_debug_defconfig
else
KERNEL_DEFCONFIG ?= k61v1_hdp_ref_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= k61v1_hdp_ref
LK_PROJECT ?= k61v1_hdp_ref
TRUSTY_PROJECT ?= k61v1_hdp_ref
