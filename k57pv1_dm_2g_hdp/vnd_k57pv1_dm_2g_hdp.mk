...
MTK_BASE_PROJECT := k57pv1_dm_2g_hdp
...
PRODUCT_NAME := vnd_k57pv1_dm_2g_hdp
PRODUCT_DEVICE := $(strip $(MTK_BASE_PROJECT))
PRODUCT_MODEL := k57pv1_dm_2g_hdp
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= k57pv1_dm_2g_hdp_debug_defconfig
else
KERNEL_DEFCONFIG ?= k57pv1_dm_2g_hdp_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= k57pv1_dm_2g_hdp
LK_PROJECT ?= k57pv1_dm_2g_hdp
TRUSTY_PROJECT ?= k57pv1_dm_2g_hdp
