...
PRODUCT_NAME := vnd_k62v1_32_bsp
PRODUCT_DEVICE := $(strip $(MTK_BASE_PROJECT))
PRODUCT_MODEL := k62v1_32_bsp
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= k62v1_32_bsp_debug_defconfig
else
KERNEL_DEFCONFIG ?= k62v1_32_bsp_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= k62v1_32_bsp
LK_PROJECT ?= k62v1_32_bsp
TRUSTY_PROJECT ?= k62v1_32_bsp
