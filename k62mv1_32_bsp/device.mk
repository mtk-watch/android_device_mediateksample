...
PRODUCT_COPY_FILES += device/mediatek/mt6765/init.mt6765.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.mt6762m.rc
PRODUCT_COPY_FILES += device/mediatek/mt6765/init.recovery.mt6765.rc:recovery/root/init.recovery.mt6762m.rc
PRODUCT_COPY_FILES += $(OUT_DIR)/target/product/$(MTK_BASE_PROJECT)/vendor/etc/fstab.mt6765:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.mt6762m
PRODUCT_COPY_FILES += $(OUT_DIR)/target/product/$(MTK_BASE_PROJECT)/vendor/etc/fstab.mt6765:debug_ramdisk/fstab.mt6762m
PRODUCT_COPY_FILES += $(OUT_DIR)/target/product/$(MTK_BASE_PROJECT)/vendor/etc/fstab.mt6765:ramdisk/fstab.mt6762m
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/k62mv1_32_bsp/factory/res/sound/testpattern1.wav:$(TARGET_COPY_OUT_VENDOR)/res/sound/testpattern1.wav:mtk
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/k62mv1_32_bsp/factory/res/sound/ringtone.wav:$(TARGET_COPY_OUT_VENDOR)/res/sound/ringtone.wav:mtk
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/k62mv1_32_bsp/factory/res/images/lcd_test_00.png:$(TARGET_COPY_OUT_VENDOR)/res/images/lcd_test_00.png:mtk
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/k62mv1_32_bsp/factory/res/images/lcd_test_01.png:$(TARGET_COPY_OUT_VENDOR)/res/images/lcd_test_01.png:mtk
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/k62mv1_32_bsp/factory/res/images/lcd_test_02.png:$(TARGET_COPY_OUT_VENDOR)/res/images/lcd_test_02.png:mtk
