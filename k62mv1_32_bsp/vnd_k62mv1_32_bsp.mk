MTK_TARGET_PROJECT := k62mv1_32_bsp
MTK_BASE_PROJECT := k62mv1_32_bsp
...
PRODUCT_NAME := vnd_k62mv1_32_bsp
...
KERNEL_DEFCONFIG ?= k62mv1_32_bsp_debug_defconfig
else
KERNEL_DEFCONFIG ?= k62mv1_32_bsp_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= k62mv1_32_bsp
LK_PROJECT ?= k62mv1_32_bsp
TRUSTY_PROJECT ?= k62mv1_32_bsp
