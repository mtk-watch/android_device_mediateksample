...
PRODUCT_NAME := full_k37tv1_64_bsp
PRODUCT_DEVICE := k37tv1_64_bsp
PRODUCT_MODEL := k37tv1_64_bsp
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= k37tv1_64_bsp_debug_defconfig
else
KERNEL_DEFCONFIG ?= k37tv1_64_bsp_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= k37tv1_64_bsp
LK_PROJECT ?= k37tv1_64_bsp
TRUSTY_PROJECT ?= k37tv1_64_bsp
