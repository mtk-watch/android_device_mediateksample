...
MTK_BASE_PROJECT := k37mv1_bsp_512
...
PRODUCT_NAME := vnd_k37mv1_bsp_512
PRODUCT_DEVICE := $(strip $(MTK_BASE_PROJECT))
PRODUCT_MODEL := k37mv1_bsp_512
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= k37mv1_bsp_512_debug_defconfig
else
KERNEL_DEFCONFIG ?= k37mv1_bsp_512_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= k37mv1_bsp_512
LK_PROJECT ?= k37mv1_bsp_512
TRUSTY_PROJECT ?= k37mv1_bsp_512
