MTK_TARGET_PROJECT := k61v1_64_bsp
MTK_BASE_PROJECT := k61v1_64_bsp
...
PRODUCT_NAME := vnd_k61v1_64_bsp
PRODUCT_DEVICE := $(strip $(MTK_BASE_PROJECT))
PRODUCT_MODEL := k61v1_64_bsp
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= k61v1_64_bsp_debug_defconfig
else
KERNEL_DEFCONFIG ?= k61v1_64_bsp_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= k61v1_64_bsp
LK_PROJECT ?= k61v1_64_bsp
TRUSTY_PROJECT ?= k61v1_64_bsp
