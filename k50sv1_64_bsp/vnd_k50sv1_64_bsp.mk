MTK_TARGET_PROJECT := k50sv1_64_bsp
MTK_BASE_PROJECT := k50sv1_64_bsp
...
PRODUCT_NAME := vnd_k50sv1_64_bsp
PRODUCT_DEVICE := $(strip $(MTK_BASE_PROJECT))
PRODUCT_MODEL := k50sv1_64_bsp
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= k50sv1_64_bsp_debug_defconfig
else
KERNEL_DEFCONFIG ?= k50sv1_64_bsp_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= k50sv1_64_bsp
LK_PROJECT ?= k50sv1_64_bsp
TRUSTY_PROJECT ?= k50sv1_64_bsp
