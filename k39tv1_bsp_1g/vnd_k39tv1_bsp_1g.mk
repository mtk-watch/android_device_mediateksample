MTK_TARGET_PROJECT := k39tv1_bsp_1g
MTK_BASE_PROJECT := k39tv1_bsp_1g
...
PRODUCT_NAME := vnd_k39tv1_bsp_1g
PRODUCT_DEVICE := $(strip $(MTK_BASE_PROJECT))
PRODUCT_MODEL := k39tv1_bsp_1g
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= k39tv1_bsp_1g_debug_defconfig
else
KERNEL_DEFCONFIG ?= k39tv1_bsp_1g_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= k39tv1_bsp_1g
LK_PROJECT ?= k39tv1_bsp_1g
TRUSTY_PROJECT ?= k39tv1_bsp_1g
