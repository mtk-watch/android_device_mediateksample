...
-include vendor/mediateksample/k39tv1_bsp/BoardConfigVendor.mk

# Use the 6739 common part
include device/mediatek/mt6739/BoardConfig.mk

TARGET_BOARD_INFO_FILE := device/mediateksample/k39tv1_bsp/board-info.txt

# MNTL project
ifeq ($(strip $(MNTL_SUPPORT)), yes)
TARGET_USERIMAGES_USE_EXT4 := true
TARGET_USERIMAGES_USE_MNTL := true
...
BOARD_MTK_SYSTEM_SIZE_KB := 1258292
BOARD_MTK_PRODUCT_SIZE_KB := 1048576
BOARD_MTK_CACHE_SIZE_KB := 114688
BOARD_MTK_VENDOR_SIZE_KB := 307200
BOARD_MTK_SUPER_SIZE_KB := 2204468
