...
PRODUCT_NAME := vnd_k39tv1_bsp
PRODUCT_DEVICE := $(strip $(MTK_BASE_PROJECT))
PRODUCT_MODEL := k39tv1_bsp
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= k39tv1_bsp_debug_defconfig
else
KERNEL_DEFCONFIG ?= k39tv1_bsp_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= k39tv1_bsp
LK_PROJECT ?= k39tv1_bsp
TRUSTY_PROJECT ?= k39tv1_bsp
